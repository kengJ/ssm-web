...
<form class="form-inline" role="form" style="float:left;">
  <div class="form-group has-feedback">
    <div class="input-group input-group-sm">
      ...
      <input id="queryText" class="form-control" type="text" placeholder="请输入查询条件" style="width: 400px">
    </div>
  </div>
  <button id="queryBtn" type="button" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-search"></i> 查询</button>
</form>
<button type="button" class="btn btn-danger btn-sm" onclick="deleteUsers()" style="float:right;margin-left:10px;"><i class=" glyphicon glyphicon-remove"></i> 删除</button>
<button type="button" class="btn btn-primary btn-sm" style="float:right;" onclick="window.location.href='${APP_PATH}/User/Add'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
<br>
 <hr style="clear:both;">
            		...
            		success : function(result) {
            			...
            			if ( result.success ) {
            				...
            				if ( pageno > 1 ) {
            					...
            					pageContent += '<li class="disabled"><a href="#" onclick="pageQuery('+(pageno-1)+')">上一页</a></li>';
            				}
            				...
            				if ( pageno < userPage.totalno ) {
            					...
            					pageContent += '<li class="disabled"><a href="#" onclick="pageQuery('+(pageno+1)+')">下一页</a></li>';
            				}
